...
class Model:
    ...
    def _is_signature_from_type_hint(self):
        return (
            self.signature._is_signature_from_type_hint
    ...
    def _is_type_hint_from_example(self):
        return (
            self.signature._is_type_hint_from_example
            if self.signature is not None
            else False
        )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if self.signature is not None:
            ...
            res["is_signature_from_type_hint"] = (
                self.signature._is_signature_from_type_hint
            )
    ...
    def from_dict(cls, model_dict) -> "Model":
        ...
        if "signature" in model_dict and isinstance(model_dict["signature"], dict):
            ...
            if "type_hint_from_example" in model_dict:
                signature._is_type_hint_from_example = model_dict.pop(
                    "type_hint_from_example"
                )
