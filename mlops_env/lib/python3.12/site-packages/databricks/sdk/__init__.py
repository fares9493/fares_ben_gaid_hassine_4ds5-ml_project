...
class WorkspaceClient:
    ...
    def __init__(
        ...
        *,
        ...
        self._artifact_allowlists = service.catalog.ArtifactAllowlistsAPI(
            self._api_client
        )
        self._catalogs = service.catalog.CatalogsAPI(self._api_client)
        self._clean_room_assets = service.cleanrooms.CleanRoomAssetsAPI(
            self._api_client
        )
        self._clean_room_task_runs = service.cleanrooms.CleanRoomTaskRunsAPI(
            self._api_client
        )
        ...
        self._consumer_fulfillments = service.marketplace.ConsumerFulfillmentsAPI(
            self._api_client
        )
        self._consumer_installations = service.marketplace.ConsumerInstallationsAPI(
            self._api_client
        )
        self._consumer_listings = service.marketplace.ConsumerListingsAPI(
            self._api_client
        )
        self._consumer_personalization_requests = (
            service.marketplace.ConsumerPersonalizationRequestsAPI(self._api_client)
        )
        self._consumer_providers = service.marketplace.ConsumerProvidersAPI(
            self._api_client
        )
        self._credentials = service.catalog.CredentialsAPI(self._api_client)
        self._credentials_manager = service.settings.CredentialsManagerAPI(
            self._api_client
        )
        ...
        self._external_locations = service.catalog.ExternalLocationsAPI(
            self._api_client
        )
        ...
        self._global_init_scripts = service.compute.GlobalInitScriptsAPI(
            self._api_client
        )
        ...
        self._permission_migration = service.iam.PermissionMigrationAPI(
            self._api_client
        )
        ...
        self._policy_compliance_for_clusters = (
            service.compute.PolicyComplianceForClustersAPI(self._api_client)
        )
        self._policy_compliance_for_jobs = service.jobs.PolicyComplianceForJobsAPI(
            self._api_client
        )
        self._policy_families = service.compute.PolicyFamiliesAPI(self._api_client)
        self._provider_exchange_filters = (
            service.marketplace.ProviderExchangeFiltersAPI(self._api_client)
        )
        self._provider_exchanges = service.marketplace.ProviderExchangesAPI(
            self._api_client
        )
        self._provider_files = service.marketplace.ProviderFilesAPI(self._api_client)
        self._provider_listings = service.marketplace.ProviderListingsAPI(
            self._api_client
        )
        ...
        self._provider_providers = service.marketplace.ProviderProvidersAPI(
            self._api_client
        )
        ...
        self._query_visualizations = service.sql.QueryVisualizationsAPI(
            self._api_client
        )
        self._query_visualizations_legacy = service.sql.QueryVisualizationsLegacyAPI(
            self._api_client
        )
        self._recipient_activation = service.sharing.RecipientActivationAPI(
            self._api_client
        )
        ...
        self._storage_credentials = service.catalog.StorageCredentialsAPI(
            self._api_client
        )
        ...
        self._temporary_table_credentials = (
            service.catalog.TemporaryTableCredentialsAPI(self._api_client)
        )
        ...
        self._vector_search_indexes = service.vectorsearch.VectorSearchIndexesAPI(
            self._api_client
        )
        ...
        self._workspace_bindings = service.catalog.WorkspaceBindingsAPI(
            self._api_client
        )
...
class AccountClient:
    ...
    def __init__(
        ...
        *,
        ...
        self._custom_app_integration = service.oauth2.CustomAppIntegrationAPI(
            self._api_client
        )
        self._encryption_keys = service.provisioning.EncryptionKeysAPI(self._api_client)
        self._federation_policy = service.oauth2.AccountFederationPolicyAPI(
            self._api_client
        )
        self._groups = service.iam.AccountGroupsAPI(self._api_client)
        self._ip_access_lists = service.settings.AccountIpAccessListsAPI(
            self._api_client
        )
        ...
        self._network_connectivity = service.settings.NetworkConnectivityAPI(
            self._api_client
        )
        self._networks = service.provisioning.NetworksAPI(self._api_client)
        self._o_auth_published_apps = service.oauth2.OAuthPublishedAppsAPI(
            self._api_client
        )
        ...
        self._service_principals = service.iam.AccountServicePrincipalsAPI(
            self._api_client
        )
        ...
        self._storage_credentials = service.catalog.AccountStorageCredentialsAPI(
            self._api_client
        )
        ...
        self._workspace_assignment = service.iam.WorkspaceAssignmentAPI(
            self._api_client
        )
